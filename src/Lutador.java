public class Lutador {
    ...
    void mostrarNaLista(int numero) {
        ...
        linha = linha + completar(this.estilo, 12);
        linha = linha + completar("" + this.danoSoco, 5);
        linha = linha + completar("" + this.danoChute, 5);
        linha = linha + completar("" + this.danoEspecial, 5);
        linha = linha + completar("" + this.defesa, 5);
